...
public class ProjectTaskRepositoryHibernImpl implements ProjectTaskRepository {
	...
	public List<ProjectSubTask> findAllByProjectTask(ProjectTask projectTask) {
        ...
        theQuery = currentSession.createQuery("from ProjectSubTask where projectTask=:projectTaskId", ProjectSubTask.class);
    	theQuery.setParameter("projectTaskId", projectTask);
